...
-- 7. Extreme Security: Row Level Security (RLS)
...
-- Patients only see their own clinical data
...
-- Nutritionists only see their linked patients
...
-- Explicitly block Admins from Clinical Data (Handled by absence of policies for Admin role)
